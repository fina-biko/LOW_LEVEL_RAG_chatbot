        ...
        try:
            if ExtractorFactory._isvalid(filepath=filepath):
                ...
                if ext in cls._registry:
                    ...
                    raise DataFactoryError(error_msg)
            else:
                
                raise DataFactoryError(message=f"The file path {filepath} does not exist.") 
        except (FileNotFoundError,Exception) as e:
            raise DataFactoryError(message=f"The file path {filepath} does not exist.",exception=e)                 
...
if __name__ == "__main__":
    ...
    print("---------------------------------------------------")
    filepath=r"C:\Users\User\Downloads\Cloud Concepts [Slid].pdf"
    filepath1=r"C:\Users\User\Downloads\Cloud Concepts [Slides].pdf"
    print(ExtractorFactory.find_extractor(filepath=filepath1))
    #print("---------------------------------------------------")
